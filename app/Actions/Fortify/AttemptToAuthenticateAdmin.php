...
class AttemptToAuthenticateAdmin
{
    /**
    ...
    {
        config(['fortify.guard' => 'admin']); // Ensure the admin guard is used
     ...
     * @return mixed
     */
    protected function handleUsingCustomCallback(Request $request, Closure $next)
    {
